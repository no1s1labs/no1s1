...
This prototype implementation started as a research project between [Dezentrum](https://www.dezentrum.ch/en/case-studies/no1s1) and [ETH Zurich Chair of IC](https://ic.ibi.ethz.ch/). We are now doing research at the [ETH Zurich CEA Lab](https://cea.ibi.ethz.ch/). The prototype is also exhibited and we give talks under the coordination of [no1s1 labs](https://www.no1s1labs.org/). If you are interested in a collaboration, please contact us.
